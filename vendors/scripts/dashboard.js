...
if (typeof ApexCharts !== "undefined") {
  const chartConfigs = [
    { id: "#chart", options },
    { id: "#chart2", options: options2 },
    { id: "#chart3", options: options3 },
    { id: "#chart4", options: options4 },
    { id: "#chart5", options: options5 },
    { id: "#chart6", options: options6 },
  ];

  chartConfigs.forEach((cfg) => {
    const el = document.querySelector(cfg.id);
    if (el) {
      new ApexCharts(el, cfg.options).render();
    }
  });
}
